...
class GuestDash extends Component {
    ...
    roomList() {
        ...
        const renderList = currentList.map((filterRooms, index) => {
            return <li className="list-group-item py-sm-0" key={index}><p>{filterRooms.innerText || filterRooms.room_name}</p></li>;
        });
        ...
        const renderPageNumbers = pageNumbers.map(number => {
            return (
                <li className="paginationStyle" key={number} id={number} onClick={this.handleClick}>
                    {number}
                </li>
            );
        });
        ...
        return (
            <div>
                ...
                <div style={{height: 140}}>
                    <ul className="guest-list">{renderList}</ul>
                </div>
            </div>
        )
    }
        ...
        return (
            <div className="container-fluid" style={{height: "100px"}}>
                ...
                <div className="card-group" >
                    <div className="card border rounded col-sm-7" style={{padding: "5px", margin: '10px'}}>
                        {this.renderMap()}
                ...
                <div className="card-group">
                    <div className="card border rounded col-sm-3 h-70" style={{padding: "5px", margin: '10px'}}>
                        <div className="card-body text-center">
                            <h5 className="card-title text-center"><strong>Register For More Features!</strong></h5>
                            <img className="card-img-top logoColour text-center" src={logo} style={{paddingTop: '20px', width: '200px'}} alt="Card image cap" />
                        </div>
                        <div className="card-footer">
                            <div className="text-center">
                                <a href={"/faq"} className="btn btn-danger col-sm-3 text-center" style={{marginLeft: "5px", paddingLeft: "10px"}}>View FAQ</a>
                                <a href={"/login"} className="btn btn-success col-sm-5 text-center" style={{marginLeft: "5px"}}>Register</a>
                                <a href={"https://gitlab.eeecs.qub.ac.uk/40126401/csc4008frontend"} className="btn btn-danger col-sm-3 text-center" style={{marginLeft: "5px", paddingLeft: "10px"}}>View Help</a>
                            </div>
                        </div>
                    </div>
                    <div className="card border rounded col-sm-6" style={{padding: "5px", margin: '10px'}}>
                        <div className="card-body guest-rooms">
